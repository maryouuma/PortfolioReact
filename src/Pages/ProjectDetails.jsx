...
function ProjectDetails() {
  ...
  const getIconForTech = (techName) => {
    ...
    if (
      ...
      techLower.includes("unity")
    ) {
      return <Code2 className="w-10 h-10 text-purple-400" />;
    }

    if (
      techLower.includes("java") ||
      techLower.includes("spring") ||
      techLower.includes("c#") ||
      techLower.includes(".net") ||
      techLower.includes("php") ||
      techLower.includes("python")
    ) {
      return <Braces className="w-10 h-10 text-green-400" />;
    }
    ...
    if (
      ...
      return <FileCode className="w-10 h-10 text-yellow-400" />;
    }

    return <Cpu className="w-10 h-10 text-pink-400" />;
  };

  if (loading) {
    return (
      <div
        className={`min-h-screen bg-gradient-to-br ${colors.bg.primary} flex items-center justify-center pt-20`}
      >
  ...
  if (error) {
    return (
      <div
        className={`min-h-screen bg-gradient-to-br ${colors.bg.primary} flex items-center justify-center px-4 pt-20`}
      >
        <FadeIn>
          <div
          ...
          >
            ...
            <button
              ...
              className="group inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-purple-500/50 transition-all duration-300 hover:scale-105"
            >
  ...
  return (
    <section
      className={`min-h-screen bg-gradient-to-br ${colors.bg.primary} pt-24 pb-12 px-4`}
    >
      <div className="max-w-6xl mx-auto">
        ...
        <FadeIn delay={0.4}>
          ...
          >
            {/* Header */}
            <div className="h-48 bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600 relative overflow-hidden">
            ...
            <div className="p-8 md:p-12 space-y-8">
              ...
              {project.description && (
                <FadeIn delay={0.8}>
                  ...
                  >
                    <p
                      className={`${colors.text.primary} leading-relaxed text-lg`}
                    >
                      {project.description}
                    </p>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-4 md:gap-6 justify-center">
                    {project.techStack.map((tech, index) => (
                      <ScaleIn key={tech} delay={1 + index * 0.1}>
                        <div className="group relative flex flex-col items-center gap-3">
                          <div className="relative">
                            <div className="w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-purple-500/20 to-pink-500/20 border-2 border-purple-500/30 rounded-full flex items-center justify-center hover:scale-110 hover:rotate-12 transition-all duration-300 cursor-pointer shadow-lg hover:shadow-purple-500/50">
                              {getIconForTech(tech)}
                            </div>
                            <div className="absolute left-1/2 -translate-x-1/2 top-full h-8 w-0.5 bg-gradient-to-b from-purple-500/50 to-transparent"></div>
                          </div>
                          <span className="text-xs md:text-sm font-medium text-purple-300 bg-gray-900/50 px-2 md:px-3 py-1 rounded-lg border border-purple-500/30 text-center max-w-[100px] break-words">
                            {tech}
                          </span>
                        </div>
                      </ScaleIn>
                ...
                <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
                  {project.documentationUrl && (
                    <button
                      ...
                      className="group inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-red-600 to-orange-600 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-red-500/50 transition-all duration-300 hover:scale-105 border border-red-400"
                    >
                  ...
                  {project.githubUrl && (
                    <button
                      ...
                      className="group inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-gray-700 to-gray-800 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-gray-900/50 transition-all duration-300 hover:scale-105 border border-gray-600"
                    >
                  ...
                  {images.length > 0 && (
                    <button
                      ...
                      className="group inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-cyan-600 to-blue-600 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-cyan-500/50 transition-all duration-300 hover:scale-105 border border-cyan-400"
                    >

...
function ProjectsList() {
  ...
  return (
    <section
      className={`min-h-screen bg-gradient-to-br ${colors.bg.primary} px-4 pt-24 pb-16`}
    >
      <div className="max-w-7xl mx-auto">
        ...
        <header className="text-center mb-16 space-y-4">
          ...
          <FadeIn delay={0.6}>
            <p className={`${colors.text.secondary} text-lg max-w-2xl mx-auto`}>
              Une sélection de réalisations web et mobiles, développées avec
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {projects.map((project, index) => (
            <ScaleIn key={project.id} delay={0.8 + index * 0.1}>
              <article
              ...
              >
                {/* Bandeau visuel */}
                <div className="h-40 bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600 relative overflow-hidden">
                ...
                <div className="p-6 flex flex-col space-y-4">
                  ...
                  {project.description && (
                    <p
                      className={`text-sm ${colors.text.secondary} line-clamp-3 flex-grow`}
                    >
                      {project.description}
                    </p>
                  )}
                  ...
                  <Link
                    ...
                    className="group/btn inline-flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-purple-500/50 transition-all duration-300 hover:scale-105"
                  >

  ...
  return (
    <FadeIn duration={0.4}>
      <div className="fixed top-4 right-4 z-[100]">
        <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 text-white px-6 py-4 rounded-xl shadow-2xl shadow-emerald-500/50 flex items-center gap-3">
              ...
              >
                ...
                >
                  <div className="flex items-center gap-3 mb-4">
                    <div
                      className={`w-10 h-10 ${card.iconBg} border ${card.iconBorder} rounded-lg flex items-center justify-center`}
                    >
      ...
      >
        <div className="space-y-4">
          ...
          <button
            ...
            disabled={loading}
            className="w-full px-6 py-3 bg-gradient-to-r from-pink-600 to-pink-700 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-pink-500/50 transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
              <>
                <div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin"></div>

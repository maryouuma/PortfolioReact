...
const AdminLayout = () => {
  ...
  return (
    <div className={`flex min-h-screen bg-gradient-to-br ${colors.bg.primary}`}>
      {/* Sidebar Admin */}
      <aside
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                {active && (
                  <>
                    <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl shadow-lg shadow-purple-500/50"></div>

...
const Navbar = () => {
  ...
  return (
    <nav className="fixed w-full top-0 z-50">
      {/* Navbar principale */}
      <div className="bg-gradient-to-r from-pink-500 to-purple-700 shadow-2xl backdrop-blur-md rounded-b-3xl border-b border-pink-400/50">
      ...
      {/* Mobile menu animé */}
      <div
        className={`fixed top-0 left-0 w-64 h-full bg-gradient-to-b from-pink-500 to-purple-700 backdrop-blur-md shadow-2xl border-r border-pink-400 transform transition-transform duration-500 ${
